...
import operation.admin.bu_notification as Utils
...
class Notifications(Resource):
    ...
    def get(self, **auth):
        ...
        parser.add_argument('level', type=int, required=False, location='args')
        ...
        rst = Utils.getNotificationList(global_var['db'], args)
